                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <button type="button" class="btn_abrir_modal btn btn-outline-success">Crear Cliente</button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label class="mb-2">Nombre:</label>
                                <input type="text" class="form-control" name="txtNombre" placeholder="Nombre del Cliente" id="txtNombre" />
                                <input type="hidden" id="clienteId" /> <!-- Campo oculto para el ID del cliente -->
                            </div>
                        </div>
                    </div>
                </div>
