...
<head>
    ...
    <script src="./../../services/estado.js" ></script>
    <title>Estado</title>
...
<body>
                ...
                <div class="card-header">
                   <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <button type="button" class="btn_abrir_modal btn btn-outline-success">Crear Estado</button>
                        </div>
                   </div>
                </div>
                <div class="card-body">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Crear Estado</h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label class="mb-2">Nombre:</label>
                                <input type="text" class="form-control" name="txtNombre" placeholder="Nombre del Estado" id="txtNombre" />
                                <input type="hidden" id="estadoId" /> <!-- Campo oculto para el ID del estado -->
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="toast" id="registroToast" role="alert" aria-live="assertive" aria-atomic="true" style="position: absolute; top: 20px; right: 20px;">
        ...
        <div class="toast-body">
            El estado se ha registrado exitosamente.
        </div>
    </div>
